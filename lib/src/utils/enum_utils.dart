...
class EnumUtils {
  ...
  static List<TranslatedEnum<TEnum>>
      getTranslatedAndSortedEnumWithAllValue<TEnum>(
    TEnum allValue,
    String allValueText,
    List<TEnum> values,
    String Function(TEnum, int) itemText, {
  ...
  static List<TranslatedEnumWithIcon<TEnum>>
      getTranslatedAndSortedEnumWithIcon<TEnum>(
    List<TEnum> values,
    String Function(TEnum, int) itemText,
    ...
    final translatedValues = filterValues
        .mapIndex(
          (filter, index) => TranslatedEnumWithIcon<TEnum>(
            filter,
            itemText(filter, index),
            iconData(filter, index),
          ),
        )
        .toList();
  ...
  static List<TranslatedEnumWithIcon<TEnum>>
      getTranslatedAndSortedEnumWithAllValueAndIcon<TEnum>(
    TEnum allValue,
    String allValueText,
    ...
    final translatedValues = filterValues
        .mapIndex(
          (filter, index) => TranslatedEnumWithIcon<TEnum>(
            filter,
            filter == allValue ? allValueText : itemText(filter, index),
            filter == allValue ? allValueIcon : iconData(filter, index),
          ),
        )
        .toList();
